...
**Thành viên:** Đặng Sỹ Tiến - 2A202600937  · Nguyễn Minh Anh-2A202600905 · Nguyễn Trung Dân-2A202600937 · Trần Nhất Huy-2A202600731 
...
*Nguồn gốc dữ liệu:* Trải nghiệm thực tế của chính các thành viên trong nhóm khi lướt xem các bài viết, video TikTok review quán ăn, sau đó có những buổi đi chơi cùng bạn bè và phải mất tận nửa tiếng đồng hồ chỉ để chật vật tìm một quán ăn gần đây, vừa phù hợp với nhu cầu lại vừa đúng tầm giá của cả nhóm.
...
| Video "50 quán ăn ở Hà Nội nhất định phải ăn" — 72K like, 34K lưu — comment: "xa quá", "quán này đóng rồi". | TikTok @mây | Người tìm quán theo chủ đề | Volume lớn nhưng thiếu filter cá nhân — user không chốt được quyết định. |
...
### Lỗi #3 — AI phản hồi chậm trong khi user muốn kết quả nhanh
* **Xuất hiện khi:** Hệ thống gặp độ trễ lúc gọi API hoặc tải bản đồ trong bối cảnh người dùng có áp lực thời gian lớn (cần chốt nhanh vị trí trước khi bắt đầu di chuyển, đang quá đói, hoặc cần di chuyển gấp trước giờ quán đóng cửa).
* **Ai chịu thiệt / Nặng đến đâu:** User mất kiên nhẫn, thoát ứng dụng và tự đưa ra quyết định thủ công hoặc chấp nhận nhịn ăn -> trực tiếp giảm retention rate của sản phẩm.
* **Prototype xử lý bằng cách nào:** Tối ưu hóa UI/UX bằng cách hiển thị trạng thái Loading kèm các câu thoại giữ chân thông minh, song song với việc xây dựng cơ chế Fallback sử dụng text thô từ cơ sở dữ liệu đóng nếu API phản hồi vượt ngưỡng thời gian an toàn.
...
### Danh sách dữ liệu Test Case trọng tâm
Hệ thống kiểm thử tập trung chạy các test case mang tính biên và đa dạng vùng miền để tối ưu chất lượng phản hồi:
* Quán ăn quận 1 / nhất
* Thường Tín / Hà Đông
* Lẩu thái Cầu Giấy
* Ăn bánh xe
...
## 9. Tổng hợp Phân công & Tiến độ chi tiết

Bảng tổng hợp vai trò của từng thành viên gắn liền với tracking đầu việc cụ thể phụ trách:
